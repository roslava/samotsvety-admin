...
export interface LocalityV2 { country_code: string; country_ru?: string | null; country_en?: string | null; region_ru?: string | null; region_en?: string | null; locality_ru?: string | null; locality_en?: string | null; description_ru?: string | null; description_en?: string | null; latitude?: number | null; longitude?: number | null; coordinate_precision?: 'exact' | 'approximate' | 'region' | null; famous?: boolean | null }
